...
// import { AlertTriangle, BookCopy, GraduationCap, ReceiptText, Sparkles } from "lucide-react";
...
//               {currentUser?.name ?? "Reader"} profile, semester status, and your latest
//               library books.
//             </h1>
//             <p className={s.heroText}>
//               Your dashboard now keeps the important account summary at the top
//               and shows the most recent issued directly below for faster access.
//             </p>
//           </div>
//         </div>
//       </section>
          ...
          <div className={s.rightColumnGrid}>
            <article className={s.profileCard}>
              ...
              <div className={s.profileDetails}>
                ...
                <div className={s.profileDetailItem}>
                  Roll Number: {}
                  Student ID: {currentUserSummary?.rollNumber ?? "Not assigned"}
                </div>
            ...
            <article className={s.semesterCard}>
              ...
              <div className={s.semesterDetails}>
                ...
                <div className={s.semesterDetailItem}>
                  Academic Year: {currentUserSummary?.academicYear ?? "1st Tear"}
                </div>
              </div>
            </article>
          </div>
          ...
          return (
            <article key={item.key} className={s.statCard}>
                <div className={s.statHeader}>
                  ...
                  <span className={s.statLiveBadge}></span>
                </div>

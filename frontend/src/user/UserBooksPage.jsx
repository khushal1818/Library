    ...
    <div className={s.pageContainer}>
        ...
        <div className={s.heroFlex}>
          <div>
            ...
            <h1 className={s.heroTitle}>
              Book card with richer content and cleaner grouped details.
            </h1>
      ...
      <section className={s.mainSection}>
        <div className={s.sectionHeader}>
          <div>
            <h2 className={s.sectionTitle}>My Issue Books</h2>
            <p className={s.sectionSubtitle}>
              Medium-size card now sperate the headline details from the
          ...
          <label className={s.filterLabel}>
            ...
            <div className={s.searchWrapper}>
              ...
              <input
                ...
                placeholder="Search by book name, code, borrower, 
              or author"

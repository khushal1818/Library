...
//                         Save the overdue fine rule here. After saving, use the edit icon to update
//                         it again.
//                     </p>
//                 </div>
//                 {!isEditing && (
...
//                     <input type="Number" min="0" value={form.amount} onChange={(event) => void
//                         setForm((current) => ({
//                             ...current,
...
//                <label className={s.label}>
//                 <span className={s.labelSpan}>Fine Interal</span>

...
// import { AlertTriangle, ShieldEllipsis, UserRound } from "lucide-react";
        ...
        {adminStats.map((item, index) => {
          ...
          return (
            <article key={item.label} className={s.statCard}>
              ...
              {/* IMPORTANT: context માં value છે */}
              <p className={s.statValue}>{item.value}</p>

              {/* IMPORTANT: context માં note છે */}
                            ...
                            <div className={s.overdueCardInner}>
                                <div>
                                    ...
                                    <p className={s.studentDetails}>
                                        {record.studentId ?? "assigend"} | {record.email}
                                    </p>

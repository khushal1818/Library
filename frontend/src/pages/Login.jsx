...
const Login = () => {
  ...
  const handelSubmit = async (event) => {
    ...
    setLoading(true);
    try {
      console.log("Attemping login with:", {
        email: form.email,
        role: form.role,
      });
      ...
      <div className={s.mainCard}>
        <section className={s.infoPanel}>
          ...
          <h1 className={s.infoTitle}>
            Choose student or admin first, then correct library panel.
          </h1>
              ...
              <div className={s.roleContainer}>
                  ...
                  {roleChoices.map((choice) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        checked={form.role === choice.value} onChange={handleChange}
                ...
                <label className="block">
                  ...
                  <div className={s.passwordWrapper}>
                    <input type={showPassoword ? "text" : "password"} name="password" value={form.password}
                  ...
                  <button type="button" onClick={() => setShowPassword((current) => !current)}
                    ...
                    >
                      {showPassoword ? <EyeOff size={17}/> : <Eye size={17}/>}
                    </button>
                  </div>
                </label>
                ...
                <div className={s.footerFlex}>
                  <span className={s.footerText}>
                    {form.role === "admin" ? "Admin account use existing credentails"
                    : "Student signup is availabel below"}
                  </span>
                  {form.role === "user" && (
